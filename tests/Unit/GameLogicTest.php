...
class GameLogicTest extends TestCase
{
    ...
    public function testFindBestBeatSeqs()
    {
        ...
        $outStartArray = [];
        $outBeatArray = [];
        $gameLogic->findBestBeatsSeqs(64, $outStartArray, $outBeatArray);
        $this->assertEquals([[64], [64]], $outStartArray);
        $this->assertEquals([[86], [46]], $outBeatArray);
    }
